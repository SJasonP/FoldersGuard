      ...
      <Space direction="vertical" size="middle" className="content-stack">
        {project ? (
          <>
            ...
            >
              <Form.Item name="projectName" label={t('projectName')} rules={[{ required: true, whitespace: true, message: t('projectNameRequired') }]}>
                <Input.Search enterButton={t('save')} loading={projectNameSaving} onSearch={() => form.submit()} />
              </Form.Item>
            </Form>
