        ...
        <Space direction="vertical" size="middle" className="content-stack">
            ...
            {info && (
                <div className="about-grid">
                    ...
                    <Typography.Link
                        onClick={() => BrowserOpenURL(info.projectLink)}>{info.projectLink}</Typography.Link>
                    <Typography.Text>{t('openSourceLicenses')}</Typography.Text>
                    <Typography.Link
                        onClick={() => BrowserOpenURL(info.thirdPartyLink)}>{t('viewOpenSourceLicenses')}</Typography.Link>
                </div>
            )}
        </Space>
    );
